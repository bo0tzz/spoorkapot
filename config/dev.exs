...
config :spoor_kapot, SpoorKapotWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "8VfLGoCt+zVwEgwzY4QKIiQB8Z4f1UPuYex/Cu+zjzvzrsUMej53NyKmwzjyicPQ",
  watchers: [
...
config :spoor_kapot, SpoorKapotWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/spoor_kapot_web/(live|views)/.*(ex)$",
      ~r"lib/spoor_kapot_web/templates/.*(eex)$"
    ]
  ]
